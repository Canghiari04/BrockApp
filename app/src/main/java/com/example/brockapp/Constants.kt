...
const val REQUEST_CODE_ACTIVITY_NOTIFY = 3
...
const val REQUEST_CODE_GEOFENCE_NOTIFY = 4
...
const val REQUEST_CODE_CONNECTIVITY_NOTIFY = 5
...
const val REQUEST_CODE_ACTIVITY_BROADCAST_RECEIVER = 2
